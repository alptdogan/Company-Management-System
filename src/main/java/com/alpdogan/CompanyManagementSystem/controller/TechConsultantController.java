...
public class TechConsultantController {
    ...
    public ResponseEntity<TechConsultant> findTechConsultantById (@RequestParam int techConsultantId) {
    ...
    public ResponseEntity<List<TechConsultantResponseDto>> findAllTechConsultants() {
